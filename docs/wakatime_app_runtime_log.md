...
- Generated at: 2026-04-27 20:59:16 UTC
...
- Category total: 18 hrs 29 mins (45.86%)

| App | Time | Overall Percent | Category Percent |
| --- | ---: | ---: | ---: |
| `Chrome` | 18 hrs 29 mins | 45.86% | 100.00% |

### Entertainment

- Category total: 9 hrs 30 mins (23.59%)

| App | Time | Overall Percent | Category Percent |
| --- | ---: | ---: | ---: |
| `抖音` | 9 hrs 30 mins | 23.59% | 100.00% |
...
- Category total: 1 hrs 25 mins ( 3.55%)

| App | Time | Overall Percent | Category Percent |
| --- | ---: | ---: | ---: |
| `WeChat` | 1 hrs 17 mins |  3.19% | 89.74% |
| `MicrosoftOutlook` | 8 mins |  0.36% | 10.26% |

### Other

- Category total: 1 hrs 20 mins ( 3.32%)

| App | Time | Overall Percent | Category Percent |
| --- | ---: | ---: | ---: |
| `Unknown Editor` | 1 hrs 20 mins |  3.32% | 100.00% |

### Notes/Docs

- Category total: 22 mins ( 0.92%)

| App | Time | Overall Percent | Category Percent |
| --- | ---: | ---: | ---: |
| `WPSOffice` | 21 mins |  0.90% | 97.43% |
| `Zotero` | 24 secs |  0.02% |  1.81% |
| `MiaoYan` | 10 secs |  0.01% |  0.76% |
